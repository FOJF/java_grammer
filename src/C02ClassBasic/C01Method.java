...
public class C01Method {
    public static void main(String[] args) {
        // for문을 이용해 1~10까지 total값 구해서 출력
        int total = 0;
        for (int i = 1; i <= 10; i++) {
            total += i;
        }
        ...
        // for문을 이용해 10~20까지 total값 구해서 출력
        int total2 = 0;
        for (int i = 10; i <= 20; i++) {
            total2 += i;
        }
